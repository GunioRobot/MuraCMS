...
<cfoutput>
	...
	#extendSetBean.getName()#
		...
		<a title="Delete" href="index.cfm?fuseaction=cExtend.updateSet&action=delete&subTypeID=#attributes.subTypeID#&extendSetID=#extendSetBean.getExtendSetID()#&siteid=#URLEncodedFormat(attributes.siteid)#" onclick="return confirmDialog('Delete  #jsStringFormat("'#extendSetBean.getname()#'")#?',this.href)">[Delete]</a>
		</li>
</cfoutput>
</cfloop>
</ul>
