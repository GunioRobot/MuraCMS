...
<cfset link=application.contentRenderer.createHREF(rsNest.type,rsNest.filename,attributes.siteid,rsnest.contentid,rsnest.target,rsnest.targetparams,"","http://" & application.settingsManager.getSite(attributes.siteid).getdomain() & attributes.context,attributes.stub,attributes.indexFile) />
