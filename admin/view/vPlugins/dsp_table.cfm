...
<cfloop query="rscategorylist">
	...
	<cfif listFind(session.mura.memberships,'S2')>
		<li class="edit"><a title="#application.rbFactory.getKeyValue(session.rb,'plugin.edit')#" href="index.cfm?fuseaction=cSettings.editPlugin&moduleID=#rscategorylist.moduleID#">#application.rbFactory.getKeyValue(session.rb,'plugin.edit')#</a></li>
	<cfelse>
	...
	<cfif listFind(session.mura.memberships,'Admin;#application.settingsManager.getSite(attributes.siteid).getPrivateUserPoolID()#;0') or listFind(session.mura.memberships,'S2')>
		<li class="permissions"><a title="#application.rbFactory.getKeyValue(session.rb,'plugin.permissions')#" href="index.cfm?fuseaction=cPerm.module&contentid=#rscategorylist.moduleID#&siteid=#URLEncodedFormat(attributes.siteid)#&moduleid=#rscategorylist.moduleID#">#application.rbFactory.getKeyValue(session.rb,'plugin.permissions')#</a></li>
	<cfelse>
