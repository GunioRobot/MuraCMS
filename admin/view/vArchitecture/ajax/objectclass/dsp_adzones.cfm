...
<cfoutput>
	<select name="availableObjects" id="availableObjects" class="multiSelect"
		...
		<cfloop query="request.rsAdZones">
			<option value="adZone~#application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.adzone')# - #request.rsAdZones.name#~#request.rsAdZones.adZoneID#">
				#application.rbFactory.getKeyValue(session.rb, 'sitemanager.content.fields.adzone')#
				-
				#request.rsAdZones.name#
			</option>
		</cfloop>
	</select>
</cfoutput>