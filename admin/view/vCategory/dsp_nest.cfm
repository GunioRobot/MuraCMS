...
<td>#application.rbFactory.getKeyValue(session.rb,'categorymanager.#yesnoformat(rslist.isActive)#')#</td>
<td class="administration"><ul class="two"><li class="edit"><a title="#application.rbFactory.getKeyValue(session.rb,'categorymanager.edit')#" href="index.cfm?fuseaction=cCategory.edit&categoryID=#rslist.categoryID#&parentID=#rslist.parentID#&siteid=#URLEncodedFormat(attributes.siteid)#">#application.rbFactory.getKeyValue(session.rb,'categorymanager.edit')#</a></li><li class="delete"><a title="#application.rbFactory.getKeyValue(session.rb,'categorymanager.delete')#" href="index.cfm?fuseaction=cCategory.update&action=delete&categoryID=#rslist.categoryID#&siteid=#URLEncodedFormat(attributes.siteid)#" onClick="return confirmDialog('#jsStringFormat(application.rbFactory.getKeyValue(session.rb,'categorymanager.deleteconfirm'))#',this.href)">#application.rbFactory.getKeyValue(session.rb,'categorymanager.delete')#</a></li></ul></td>
</tr>
