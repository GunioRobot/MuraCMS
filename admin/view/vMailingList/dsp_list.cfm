...
<cfoutput query="request.rslist">
	<tr>
		<td class="varWidth"><a title="Edit" href="index.cfm?fuseaction=cMailingList.edit&mlid=#request.rslist.mlid#&siteid=#URLEncodedFormat(attributes.siteid)#">#HTMLEditFormat(request.rslist.name)# (#request.rslist.members#)</a></td>
