...
(function() {
  ...
  var config = {
    // General
    flashplayer: basePath + 'plugins/media/mediaplayer-5.4/player.swf',
    replacement: basePath + 'plugins/media/images/replacement.gif',
    jwplayerjs: basePath + 'plugins/media/mediaplayer-5.4/jwplayer.js',
    yt: basePath + 'plugins/media/mediaplayer-5.4/yt.swf',
  ...
  function processConfig()
  {
    ...
    code += "  jwplayer('" + config['div_id'] + "').setup({\n";
